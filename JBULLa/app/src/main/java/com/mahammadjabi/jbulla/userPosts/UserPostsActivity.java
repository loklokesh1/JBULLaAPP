...
public class UserPostsActivity extends AppCompatActivity {
    ...
    private ProgressDialog progressDialogShareImage;
    ...
    String currentUserID, saveCurrentTime, saveCurrentDate, postRandomName;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UserPostImageRef = FirebaseStorage.getInstance().getReference().child("UsersPosts");
        ...
        progressDialogShareImage = new ProgressDialog(this);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot)
            {
                if (dataSnapshot.exists())
                {
                    ...
                    if (dataSnapshot.hasChild("post"))
                    {
                        ...
                        Picasso.with(UserPostsActivity.this).load(image).placeholder(R.drawable.post).into(PostImage);
                    }
                    else
                    {
...
//                progressDialogShareImage.setTitle("Please wait...");
                progressDialogShareImage.setMessage("Loading Image ...");
...
//                                            finish();
    ...
    private void ShareUserPost()
    {
        ...
        String postdescription = PostDescription.getText().toString();
        ...
        else
        {
            ...
            UsersRef.updateChildren(postsMap).addOnCompleteListener(new OnCompleteListener() {
                @Override
